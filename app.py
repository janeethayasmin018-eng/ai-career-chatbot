        ...
        if user_input:
            if client:
                try:
                    ...
                    reply = "API error. Check your key or billing."
            else:
                reply = "AI not connected. Add API key in Streamlit Secrets."
        ...
        if st.button("Get Feedback"):
            if client:
                try:
                    ...
                    result = "API error. Check key or billing."
            else:
                if len(answer) < 50:
                    result = "Answer too short. Add more details."
                else:
                    result = "Good answer! Improve clarity and confidence."
